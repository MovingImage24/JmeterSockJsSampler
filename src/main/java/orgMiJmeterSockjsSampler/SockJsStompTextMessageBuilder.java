...
public class SockJsStompTextMessageBuilder {
	...
	private SockJsStompTextMessageBuilder(StompCommand command) {
		this.command = command;
	}

	public static SockJsStompTextMessageBuilder create(StompCommand command) {
		return new SockJsStompTextMessageBuilder(command);
	}

	public SockJsStompTextMessageBuilder headers(String... headerLines) {
		this.headerLines.addAll(Arrays.asList(headerLines));
		return this;
	}

	public SockJsStompTextMessageBuilder body(String body) {
		this.body = body;
		return this;
	}
